...
@section('main')
    <x-app-layout>
        <div class="p-6 lg:p-12 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700 rounded-lg shadow-md">
            ...
            <form method="post" action="{{ route('keepass.update', $password->id) }}" class="max-w-md mx-auto space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="name" name="name" placeholder="Nom" value="{{ $password->name }}" class="border p-3 w-full rounded-md focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                </div>

                <div class="space-y-2">
                    <label for="username" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nom d'utilisateur</label>
                    <input type="text" id="username" name="username" placeholder="Nom d'utilisateur" value="{{ $password->username }}" class="border p-3 w-full rounded-md focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                </div>

                <div class="relative space-y-2">
                    <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Mot de passe</label>
                    <input type="text" id="password" name="password" placeholder="Mot de passe" value="{{ $decryptedPassword }}" class="border p-3 w-full rounded-md focus:border-blue-500 dark:bg-gray-700 dark:text-white pr-12">
